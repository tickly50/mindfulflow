...
const ActivityStats = memo(function ActivityStats({ data }) {
  ...
  return (
    <motion.div
      ...
      className="glass p-4 sm:p-6 rounded-[2rem] border-none flex flex-col h-full"
    >
      ...
      <div className="flex-1 space-y-3 overflow-y-auto pr-2 premium-scroll">
        {topStats.map((stat, idx) => {
          ...
          const moodLevel = Math.round(stat.average);
            ...
            >
              ...
              <div 
                ...
                style={{ 
                  ...
                  boxShadow: `0 4px 15px -3px ${moodColor.primary}40`
                }}
              >
                {stat.average}
              </div>
