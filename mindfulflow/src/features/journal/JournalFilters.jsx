    ...
    <div className="mb-6 md:mb-8 flex flex-col gap-4 min-w-0 w-full">
      ...
      <div className="relative w-full min-w-0">
        ...
        <input
          ...
          className="w-full min-w-0 bg-white/5 border border-white/10 rounded-2xl pl-10 pr-12 py-3.5 min-h-[48px] text-fluid-sm text-white placeholder-white/35 focus:ring-2 focus:ring-violet-500/35 focus:border-violet-500/25 hover:border-white/18 transition-[border-color,box-shadow] duration-150"
        />
        <AnimatePresence>
          {searchQuery && (
            <motion.button
